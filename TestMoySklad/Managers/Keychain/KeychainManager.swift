...
protocol KeychainManagerProtocol: AnyObject {
    func saveItem<T: Encodable>(_ item: T, itemClass: ItemClass, key: String) throws
    func retrieveItem<T: Decodable>(ofClass itemClass: ItemClass, key: String) throws -> T
    func updateItem<T: Encodable>(with item: T, ofClass itemClass: ItemClass, key: String) throws
    func deleteItem(ofClass itemClass: ItemClass, key: String) throws
    var attributes: ItemAttributes? { get set }
}
